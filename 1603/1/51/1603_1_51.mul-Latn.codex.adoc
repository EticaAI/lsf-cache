...
[id='14']
=== [`14`] Lingua Graeca antiqua (Alphabetum Graecum)
...
[id='15']
=== [`15`] Lingua Coreana (Abecedarium Coreanum)
...
[id='16']
=== [`16`] Lingua Hebraica (Alphabetum Hebraicum)
...
[id='17']
=== [`17`] Lingua Latina (Abecedarium Latinum)
...
[id='18']
=== [`18`] Lingua Russica (Abecedarium Cyrillicum)
