...
numerus editionis
|
https://www.wikidata.org/wiki/Property:2022-02-26T23:29:16[2022-02-26T23:29:16]
...
|
https://www.wikidata.org/wiki/Property:This Numerodinatio namespace contains dictionaries related to bare minimum interlingual concepts used to understand Numerodinatio tables.

The decision making is mostly based on what is very essential to explain other tables.[This Numerodinatio namespace contains dictionaries related to bare minimum interlingual concepts used to understand Numerodinatio tables.
