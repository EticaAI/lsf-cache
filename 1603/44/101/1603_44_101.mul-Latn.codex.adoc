...
Rēs linguālibus (1)::
  Lingua Anglica (Abecedarium Latinum):::
    O ***[1603:44:101] /Dictiōnāria basibus dē sceleribus contrā persōnam/*** usa o Wikidata como uma estratégia para conciliar termos linguísticos para um ou mais de seus conceitos.
    +++<br><br>+++
    ...
    **Os principais motivos para "traduções erradas" não são culpa dos tradutores**
    ...
    . O resultado da consulta, com todos os QIDs e rótulos de termos, é compartilhado como `1603_44_101.wikiq.tm.hxl.csv`
    . As traduções revisadas pela comunidade de cada QID singular são pré-compiladas em um arquivo individual `1603_44_101.wikiq.tm.hxl.csv`
    . `1603_44_101.no1.tm.hxl.csv` mais `1603_44_101.wikiq.tm.hxl.csv` criado `1603_44_101.no11.tm.hxl.csv`
