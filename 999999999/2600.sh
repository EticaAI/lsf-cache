...
if [ ! -f "${ROOTDIR}/999999/1613/2600/a-z__1__b60.tsv" ]; then
  ./999999999/0/2600.py --actionem-codex-tabulae-completum \
    --verbum-limiti=1 \
    --codex-verbum-tabulae="${_2600_b60__US_ASCII_alpha_seed}" \
    >"${ROOTDIR}/999999/1613/2600/a-z__1__b60.tsv"

  # bootstrap_999999_2600 "${_2600_b60__US_ASCII_alpha_lowercase}" 1 \
  #   > "${ROOTDIR}/999999/1613/2600/a-z__1__b60.tsv"

  sort -k1 -n "${ROOTDIR}"/999999/1613/2600/a-z__1__b60.tsv >"${ROOTDIR}"/999999/1613/2600/a-z__1__b60.sorted.tsv
  cut -f1 "${ROOTDIR}"/999999/1613/2600/a-z__1__b60.sorted.tsv | uniq -d | xargs -I '{}' sh -c "grep -w '{}' ""${ROOTDIR}""/999999/1613/2600/a-z__1__b60.sorted.tsv" >"${ROOTDIR}"/999999/1613/2600/a-z__1__b60.non-uniq.sorted.tsv
fi

if [ ! -f "${ROOTDIR}/999999/1613/2600/a-z__2__b60.tsv" ]; then
  ./999999999/0/2600.py --actionem-codex-tabulae-completum \
    --verbum-limiti=2 \
    --codex-verbum-tabulae="${_2600_b60__US_ASCII_alpha_seed}" \
    >"${ROOTDIR}/999999/1613/2600/a-z__2__b60.tsv"

  # bootstrap_999999_2600 "${_2600_b60__US_ASCII_alpha_lowercase}" 2 \
  #   > "${ROOTDIR}/999999/1613/2600/a-z__2__b60.tsv"
  sort -k1 -n "${ROOTDIR}"/999999/1613/2600/a-z__2__b60.tsv >"${ROOTDIR}"/999999/1613/2600/a-z__2__b60.sorted.tsv
  cut -f1 "${ROOTDIR}"/999999/1613/2600/a-z__2__b60.sorted.tsv | uniq -d | xargs -I '{}' sh -c "grep -w '{}' ""${ROOTDIR}""/999999/1613/2600/a-z__2__b60.sorted.tsv" >"${ROOTDIR}"/999999/1613/2600/a-z__2__b60.non-uniq.sorted.tsv
fi

if [ ! -f "${ROOTDIR}/999999/1613/2600/a-z__3__b60.tsv" ]; then
  ./999999999/0/2600.py --actionem-codex-tabulae-completum \
    --verbum-limiti=3 \
    --codex-verbum-tabulae="${_2600_b60__US_ASCII_alpha_seed}" \
    >"${ROOTDIR}/999999/1613/2600/a-z__3__b60.tsv"

  # bootstrap_999999_2600 "${_2600_b60__US_ASCII_alpha_lowercase}" 3 \
  #   > "${ROOTDIR}/999999/1613/2600/a-z__3__b60.tsv"
  sort -k1 -n "${ROOTDIR}"/999999/1613/2600/a-z__3__b60.tsv >"${ROOTDIR}"/999999/1613/2600/a-z__3__b60.sorted.tsv
  cut -f1 "${ROOTDIR}"/999999/1613/2600/a-z__3__b60.sorted.tsv | uniq -d | xargs -I '{}' sh -c "grep -w '{}' ""${ROOTDIR}""/999999/1613/2600/a-z__3__b60.sorted.tsv" >"${ROOTDIR}"/999999/1613/2600/a-z__3__b60.non-uniq.sorted.tsv
fi

if [ ! -f "${ROOTDIR}/999999/1613/2600/a-z__4__b60.tsv" ]; then
  ./999999999/0/2600.py --actionem-codex-tabulae-completum \
    --verbum-limiti=4 \
    --codex-verbum-tabulae="${_2600_b60__US_ASCII_alpha_seed}" \
    >"${ROOTDIR}/999999/1613/2600/a-z__4__b60.tsv"

  sort -k1 -n "${ROOTDIR}"/999999/1613/2600/a-z__4__b60.tsv >"${ROOTDIR}"/999999/1613/2600/a-z__4__b60.sorted.tsv
  cut -f1 "${ROOTDIR}"/999999/1613/2600/a-z__4__b60.sorted.tsv | uniq -d | xargs -I '{}' sh -c "grep -w '{}' ""${ROOTDIR}""/999999/1613/2600/a-z__4__b60.sorted.tsv" >"${ROOTDIR}"/999999/1613/2600/a-z__4__b60.non-uniq.sorted.tsv
fi

### US_ASCII_alphanum _____________________________________________________________

if [ ! -f "${ROOTDIR}/999999/1613/2600/0-9a-z__1__b60.tsv" ]; then
  ./999999999/0/2600.py --actionem-codex-tabulae-completum \
    --verbum-limiti=1 \
    --codex-verbum-tabulae="${_2600_b60__US_ASCII_alphanum_seed}" \
    >"${ROOTDIR}/999999/1613/2600/0-9a-z__1__b60.tsv"

  # bootstrap_999999_2600 "${_2600_b60__US_ASCII_alphanum_lowercase}" 1 \
  #   > "${ROOTDIR}/999999/1613/2600/0-9a-z__1__b60.tsv"

  sort -k1 -n "${ROOTDIR}"/999999/1613/2600/0-9a-z__1__b60.tsv >"${ROOTDIR}"/999999/1613/2600/0-9a-z__1__b60.sorted.tsv
  cut -f1 "${ROOTDIR}"/999999/1613/2600/0-9a-z__1__b60.sorted.tsv | uniq -d | xargs -I '{}' sh -c "grep -w '{}' ""${ROOTDIR}""/999999/1613/2600/0-9a-z__1__b60.sorted.tsv" >"${ROOTDIR}"/999999/1613/2600/0-9a-z__1__b60.non-uniq.sorted.tsv
fi

if [ ! -f "${ROOTDIR}/999999/1613/2600/0-9a-z__2__b60.tsv" ]; then
  ./999999999/0/2600.py --actionem-codex-tabulae-completum \
    --verbum-limiti=2 \
    --codex-verbum-tabulae="${_2600_b60__US_ASCII_alphanum_seed}" \
    >"${ROOTDIR}/999999/1613/2600/0-9a-z__2__b60.tsv"
  # bootstrap_999999_2600 "${_2600_b60__US_ASCII_alphanum_lowercase}" 2 \
  #   > "${ROOTDIR}/999999/1613/2600/0-9a-z__2__b60.tsv"

  sort -k1 -n "${ROOTDIR}"/999999/1613/2600/0-9a-z__2__b60.tsv >"${ROOTDIR}"/999999/1613/2600/0-9a-z__2__b60.sorted.tsv
  cut -f1 "${ROOTDIR}"/999999/1613/2600/0-9a-z__2__b60.sorted.tsv | uniq -d | xargs -I '{}' sh -c "grep -w '{}' ""${ROOTDIR}""/999999/1613/2600/0-9a-z__2__b60.sorted.tsv" >"${ROOTDIR}"/999999/1613/2600/0-9a-z__2__b60.non-uniq.sorted.tsv
fi

if [ ! -f "${ROOTDIR}/999999/1613/2600/0-9a-z__3__b60.tsv" ]; then
  ./999999999/0/2600.py --actionem-codex-tabulae-completum \
    --verbum-limiti=3 \
    --codex-verbum-tabulae="${_2600_b60__US_ASCII_alphanum_seed}" \
    >"${ROOTDIR}/999999/1613/2600/0-9a-z__3__b60.tsv"
  # bootstrap_999999_2600 "${_2600_b60__US_ASCII_alphanum_lowercase}" 3 \
  #   > "${ROOTDIR}/999999/1613/2600/0-9a-z__3__b60.tsv"

  sort -k1 -n "${ROOTDIR}"/999999/1613/2600/0-9a-z__3__b60.tsv >"${ROOTDIR}"/999999/1613/2600/0-9a-z__3__b60.sorted.tsv
  cut -f1 "${ROOTDIR}"/999999/1613/2600/0-9a-z__3__b60.sorted.tsv | uniq -d | xargs -I '{}' sh -c "grep -w '{}' ""${ROOTDIR}""/999999/1613/2600/0-9a-z__3__b60.sorted.tsv" >"${ROOTDIR}"/999999/1613/2600/0-9a-z__3__b60.non-uniq.sorted.tsv
fi

if [ ! -f "${ROOTDIR}/999999/1613/2600/0-9a-z__4__b60.tsv" ]; then
  ./999999999/0/2600.py --actionem-codex-tabulae-completum \
    --verbum-limiti=4 \
    --codex-verbum-tabulae="${_2600_b60__US_ASCII_alphanum_seed}" \
    >"${ROOTDIR}/999999/1613/2600/0-9a-z__4__b60.tsv"

  sort -k1 -n "${ROOTDIR}"/999999/1613/2600/0-9a-z__4__b60.tsv >"${ROOTDIR}"/999999/1613/2600/0-9a-z__4__b60.sorted.tsv
  cut -f1 "${ROOTDIR}"/999999/1613/2600/0-9a-z__4__b60.sorted.tsv | uniq -d | xargs -I '{}' sh -c "grep -w '{}' ""${ROOTDIR}""/999999/1613/2600/0-9a-z__4__b60.sorted.tsv" >"${ROOTDIR}"/999999/1613/2600/0-9a-z__4__b60.non-uniq.sorted.tsv
fi
